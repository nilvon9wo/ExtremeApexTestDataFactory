...
| Serialization-based mock enrichment — force read-only values; populate parent relationship objects | 📋 | [serialization-mock-enrichment.md](serialization-mock-enrichment.md) |
