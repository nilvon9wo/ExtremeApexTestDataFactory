...
| `put(List<SObjectField>, value)` — path-scoped ancestor values (literal / strategy / context-aware / relationship) | [value-expressions](value-expressions.md#setting-a-value-on-a-generated-ancestor) | `XFTY_PathValueTest` |
