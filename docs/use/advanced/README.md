...
▶ Runnable: `XFTY_Ex_Adv_UnitVsIntegrationTest`, `XFTY_Ex_Adv_DeepSetupChainsTest`,
`XFTY_Ex_Adv_StaticDeferredFixtureTest`, `XFTY_Ex_Adv_MatchingValuesTest`.
Still pending: `large-graphs`.
